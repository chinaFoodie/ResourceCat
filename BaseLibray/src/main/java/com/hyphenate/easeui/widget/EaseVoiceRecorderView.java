...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    protected TextView recordingDaoJisi;
    ...
    private void init(Context context) {
        ...
        recordingDaoJisi = (TextView) findViewById(R.id.recording_dao_ji_shi);
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (60 - recLen >= 0) {
                            if ((60 - recLen) < 5) {
                                recordingDaoJisi.setVisibility(VISIBLE);
                                recordingDaoJisi.setText("你还可以说话" + (60 - recLen) + "s将自动发送");
                            }
                        } else {
                            recordingDaoJisi.setVisibility(GONE);
                            is60s = true;
                            v.setPressed(false);
                            if (event.getY() < 0) {
