 ...
 */
public class MeetingAbsentOrLateRecyclerAdapter extends RecyclerView.Adapter<MeetingAbsentOrLateRecyclerAdapter.MyViewHolder> {
    private Context context;
    private List<MeetingAttendanceModel.MeetingAttendance.Absent> listUser;
    ...
    public MeetingAbsentOrLateRecyclerAdapter(Context context, List<MeetingAttendanceModel.MeetingAttendance.Absent> listUser) {
    ...
    @Override
    public MeetingAbsentOrLateRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final MeetingAbsentOrLateRecyclerAdapter.MyViewHolder holder, final int position) {
