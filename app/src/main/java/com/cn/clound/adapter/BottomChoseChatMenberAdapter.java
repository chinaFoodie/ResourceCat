 ...
 */
public class BottomChoseChatMenberAdapter extends RecyclerView.Adapter<BottomChoseChatMenberAdapter.MyViewHolder> {
    ...
    public BottomChoseChatMenberAdapter(Context context, List<DTUser> listUser) {
    ...
    @Override
    public BottomChoseChatMenberAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final BottomChoseChatMenberAdapter.MyViewHolder holder, final int position) {
