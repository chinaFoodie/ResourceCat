 ...
 */
public class MeetingMenberRecyclerAdapter extends RecyclerView.Adapter<MeetingMenberRecyclerAdapter.MyViewHolder> {
    ...
    public MeetingMenberRecyclerAdapter(Context context, List<BottomUserModel> listUser) {
    ...
    @Override
    public MeetingMenberRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final MeetingMenberRecyclerAdapter.MyViewHolder holder, final int position) {
