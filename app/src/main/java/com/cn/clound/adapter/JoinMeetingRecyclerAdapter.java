 ...
 */
public class JoinMeetingRecyclerAdapter extends RecyclerView.Adapter<JoinMeetingRecyclerAdapter.MyViewHolder> {
    private Context context;
    private List<EnterStadiumModel.Stadium.MeetingUser> listUser;
    ...
    public JoinMeetingRecyclerAdapter(Context context, List<EnterStadiumModel.Stadium.MeetingUser> listUser) {
    ...
    @Override
    public JoinMeetingRecyclerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
