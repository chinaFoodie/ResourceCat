...
import com.cn.clound.easemob.db.DemoDBManager;
import com.cn.clound.easemob.db.InviteMessgeDao;
import com.cn.clound.easemob.db.UserDao;
import com.cn.clound.easemob.domain.EmojiconExampleGroupData;
import com.cn.clound.easemob.domain.InviteMessage;
import com.cn.clound.easemob.domain.RobotUser;
import com.cn.clound.easemob.parse.UserProfileManager;
import com.cn.clound.easemob.receiver.CallReceiver;
import com.cn.clound.easemob.ui.ChatActivity;
import com.cn.clound.easemob.ui.VideoCallActivity;
import com.cn.clound.easemob.ui.VoiceCallActivity;
import com.cn.clound.easemob.utils.PreferenceManager;
...
public class HuanXinHelper {
    ...
    public void init(Context context) {
        ...
        demoModel = new HuanXinModel(context);
...
//        notifier.setNotificationInfoProvider(getNotificationListener());
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onAutoAcceptInvitationFromGroup(String groupId, String inviter, String inviteMessage) {
            ...
            ecm.setMsgType(ChatType.GroupChat + "");
            EMGroup group = EMClient.getInstance().groupManager().getGroup(msg.getUserName());
            if (group != null) {
                ecm.setSessionName(group.getGroupName());
                ecm.setToUSerNick(group.getGroupName());
                ecm.setToUserNo(group.getGroupId());
                ecm.setToUserAvatar("");
                ...
                ecm.setMsgType("chat_join_me");
                msg.setAttribute("extended_msg_json", GsonTools.obj2json(ecm));
                // 保存邀请消息
                EMClient.getInstance().chatManager().saveMessage(msg);
                // 提醒新消息
                getNotifier().viberateAndPlayTone(msg);
